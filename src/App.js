              ...
              <div className="w-[100%]">
                <div className="relative">
                  ...
                  right-[20px] items-center"
                    >
                      <button className="rounded-[25px] p-[2px] sm:p-[5px] bg-gradient-to-r from-teal-400 to-blue-500 hover:from-pink-500 hover:to-orange-500">
                        Login
                      </button>
                      <button className="bg-gradient-to-r from-teal-400 to-blue-500  hover:from-pink-500 hover:to-orange-500 rounded-[25px] p-[2px] sm:p-[4px]">
                        Sign up
                      </button>
                    </div>
                  </div>
